        ...
        <div class="container-section">
            <div class="container1">
                <div class="container-index-texts"><!--The banner with the welcome text.-->
                    ...
                    <p><i>If you put an email in your account it cannot be changed and payment on site.</i></p>
                    <div class="hero_buttons">
                        <a href="variety.php"><!--Button that moves you to the Veriety tab.-->
                            <button class="hero-button1">Variety</button>
                        </a>
                        <a href="account_login.php"><!--Button that moves you to the Reservation tab.-->
                            <button class="hero-button2">Login</button>
                        </a>
                    </div>
                </div>
            </div>
