        ...
        <div class="container-section">
            <div class="container-profile">
                <div class="container-profile-box"><!--The banner with the welcome text.-->
                    <!-- Get user info to show on this page -->
                    <?php include "profile_info.php"?>
                    <h2>Profile</h2>
                    
                    <!-- Show all info we just fetched -->
                    ...
                    <div class="hero_buttons">
                        <!-- Go to the log-out code -->
                        <a href="logout.php"><!--Button that moves you to the Veriety tab.-->
                            <button class="hero-button1">Log out</button>
                        </a>
                        <!-- Go to the account create page with MY user ID from MY session with MY info so we can edit MY profile -->
                ...
                <div class="container-profile-box-reservations">
                    <!-- Show reservations through the reservation code -->
                    <h2>Reservations</h2>
